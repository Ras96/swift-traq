...
open class UserTagAPI {
     ...
     */
    @discardableResult
    open class func getTag(tagId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Tag?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getTagWithRequestBuilder(tagId: UUID) -> RequestBuilder<Tag> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Tag>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
