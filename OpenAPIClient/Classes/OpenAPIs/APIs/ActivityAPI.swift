...
open class ActivityAPI {
     ...
     */
    @discardableResult
    open class func getActivityTimeline(limit: Int? = nil, all: Bool? = nil, perChannel: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [ActivityTimelineMessage]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getActivityTimelineWithRequestBuilder(limit: Int? = nil, all: Bool? = nil, perChannel: Bool? = nil) -> RequestBuilder<[ActivityTimelineMessage]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[ActivityTimelineMessage]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getOnlineUsers(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [String]?, _ error: Error?) -> Void)) -> RequestTask {
