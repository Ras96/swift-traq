...
open class MessageAPI {
     ...
     */
    @discardableResult
    open class func deleteMessage(messageId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func editMessage(messageId: UUID, postMessageRequest: PostMessageRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getMessage(messageId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Message?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func searchMessagesWithRequestBuilder(word: String? = nil, after: Date? = nil, before: Date? = nil, _in: UUID? = nil, to: UUID? = nil, from: UUID? = nil, citation: UUID? = nil, bot: Bool? = nil, hasURL: Bool? = nil, hasAttachments: Bool? = nil, hasImage: Bool? = nil, hasVideo: Bool? = nil, hasAudio: Bool? = nil, limit: Int? = nil, offset: Int? = nil, sort: Sort_searchMessages? = nil) -> RequestBuilder<MessageSearchResult> {
        ...
        let localVariableRequestBuilder: RequestBuilder<MessageSearchResult>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
