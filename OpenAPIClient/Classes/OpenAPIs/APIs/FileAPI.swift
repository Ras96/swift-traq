...
open class FileAPI {
     ...
     */
    @discardableResult
    open class func deleteFile(fileId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getFile(fileId: UUID, dl: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: URL?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getFileMeta(fileId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: FileInfo?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getFileMetaWithRequestBuilder(fileId: UUID) -> RequestBuilder<FileInfo> {
        ...
        let localVariableRequestBuilder: RequestBuilder<FileInfo>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getFiles(channelId: UUID? = nil, limit: Int? = nil, offset: Int? = nil, since: Date? = nil, until: Date? = nil, inclusive: Bool? = nil, order: Order_getFiles? = nil, mine: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [FileInfo]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getThumbnailImage(fileId: UUID, type: ThumbnailType? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: URL?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func postFile(file: URL, channelId: UUID, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: FileInfo?, _ error: Error?) -> Void)) -> RequestTask {
