...
open class WebrtcAPI {
     ...
     */
    @discardableResult
    open class func getWebRTCState(apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [WebRTCUserState]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getWebRTCStateWithRequestBuilder() -> RequestBuilder<[WebRTCUserState]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[WebRTCUserState]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func postWebRTCAuthenticate(postWebRTCAuthenticateRequest: PostWebRTCAuthenticateRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: WebRTCAuthenticateResult?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func postWebRTCAuthenticateWithRequestBuilder(postWebRTCAuthenticateRequest: PostWebRTCAuthenticateRequest? = nil) -> RequestBuilder<WebRTCAuthenticateResult> {
        ...
        let localVariableRequestBuilder: RequestBuilder<WebRTCAuthenticateResult>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
