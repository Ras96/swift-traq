...
open class Oauth2API {
     ...
     */
    @discardableResult
    open class func createClient(postClientRequest: PostClientRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: OAuth2ClientDetail?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func createClientWithRequestBuilder(postClientRequest: PostClientRequest? = nil) -> RequestBuilder<OAuth2ClientDetail> {
        ...
        let localVariableRequestBuilder: RequestBuilder<OAuth2ClientDetail>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func deleteClient(clientId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func editClient(clientId: String, patchClientRequest: PatchClientRequest? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func getClient(clientId: String, detail: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: GetClient200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getClientWithRequestBuilder(clientId: String, detail: Bool? = nil) -> RequestBuilder<GetClient200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetClient200Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getClients(all: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [OAuth2Client]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getClientsWithRequestBuilder(all: Bool? = nil) -> RequestBuilder<[OAuth2Client]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[OAuth2Client]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func postOAuth2AuthorizeDecide(submit: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func postOAuth2TokenWithRequestBuilder(grantType: String, code: String? = nil, redirectUri: String? = nil, clientId: String? = nil, codeVerifier: String? = nil, username: String? = nil, password: String? = nil, scope: String? = nil, refreshToken: String? = nil, clientSecret: String? = nil) -> RequestBuilder<OAuth2Token> {
        ...
        let localVariableRequestBuilder: RequestBuilder<OAuth2Token>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func revokeOAuth2Token(token: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
